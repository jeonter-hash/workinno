 ...
 * A4 가로(10.8333" × 7.5") · 맑은 고딕 · 한국표준협회 로고
 * 실행: node example_deck.js [ksa_logo.png] [출력.pptx]
...
(async () => {
  const deck = B.createDeck({ logo: LOGO, title: '예시 덱', author: '한국표준협회' });

  // ── 1. 표지 (Hero Gradient 1/3)
  B.cover(deck, {
    chapter: '한국표준협회',
    title: '브랜드 유입만 3년째 커지고 있다',
  ...
  // ── 2. 패턴 A — KPI 스트립 + 차트
  {
    ...
    B.headline(s, '성장은 브랜드 검색 한 곳에서 나왔다');
  ...
  // ── 3. 패턴 B — 2열 비교 + So What
  {
    ...
    B.headline(s, '예산을 브랜드 자산으로 다시 배분한다');

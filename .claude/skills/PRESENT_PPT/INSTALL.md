...
만든 뒤 `check_layout.py`가 잡는 것: A4 판형 · 맑은 고딕 외 폰트(표·차트 내부까지) · 9.5pt 미만 · 슬라이드 밖 이탈 · 본문 벽 침범(네이티브 표는 실제 행 높이 합산) · 5존 앵커 이탈 · 하단 30% 공백 · 의도하지 않은 검은 윤곽선 · 흐린 글자색 · 유채색 · 로고 위치/비율/로고 뒤 도형 · 이모지 · 차트 구조 결함.

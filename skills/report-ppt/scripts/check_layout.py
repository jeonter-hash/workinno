...
검사 항목
  ...
  13  각주 과다 — 한 장표에 잔글씨 3줄 이상
 13b  결론 밴드 남용 — 결론 밴드가 본문 장표의 60% 초과
  14  문안 — 이중 피동·상투구·수치 없는 평가어 (헤드 존은 검사에서 뺀다)
  15  표만 있는 장표 — 표가 본문 65%를 넘게 차지하고 차트도 없는 장표
 15b  표 편중 — 그런 장표가 본문의 절반을 넘는가
...
BAD_PHRASE = [
    ...
    (re.compile(r"^[^\n—:]{2,14} — ", re.M), "부연설명 구분자 — 줄표 대신 쌍점(:)을 쓸 것"),
]

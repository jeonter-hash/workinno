...
| 파일 | 내용 |
|---|---|
| `tools/audit_skills.py` | 스킬 문서가 코드와 어긋났는지 점검 — 공용 파일·export·규칙 번호·좌표·수치 주장·폐기 문구·명령어·기관명 |
